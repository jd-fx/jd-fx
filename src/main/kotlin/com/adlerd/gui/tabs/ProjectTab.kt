 ...
 * tree to open into.
 */
class ProjectTab(projectPath: File): CustomTab() {
    ...
    init {
        this.packageImg = Image(
            ProjectTab::class.java.getResource("/img/small_folder.png").toExternalForm(),
            ICON_SIZE,
            ICON_SIZE,
            true,
            false
        ...
        this.genericFileImg = Image(
            ProjectTab::class.java.getResource("/img/small_generic_file.png").toExternalForm(),
            ICON_SIZE,
            ICON_SIZE,
            true,
            false
        ...
        this.javaFileImg = Image(
            ProjectTab::class.java.getResource("/img/small_java_file.png").toExternalForm(),
            ICON_SIZE,
            ICON_SIZE,
            true,
            false
        ...
        this.classFileImg = Image(
            ProjectTab::class.java.getResource("/img/small_class_file.png").toExternalForm(),
            ICON_SIZE,
            ICON_SIZE,
            true,
            false
